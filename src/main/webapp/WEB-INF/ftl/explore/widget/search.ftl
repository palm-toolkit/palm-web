...
<div id="boxbody-${wUniqueName}" class="box-body no-padding wsetup">
  	<div id="search-widget" class="nav-tabs-custom display-none">
  		<div id="search_words" class="fleft width50p" >
	  		<div class="type_search_words"></div>
	  		<div class="scroll-search-words"></div>
	  	</div>
  		<div class="vis_options"></div>
...
<script>
	$( function()
	{
		...
		var topicBorderProp = "";
		var backGroundColor = "#c0c5bf";
		var researcherBackground = backGroundColor;
		var conferenceBackground = backGroundColor;
		var publicationBackground = backGroundColor;
		var topicBackground = backGroundColor;
		var resetFlag = "1";
		var currentVisType = "";
