...
<script>
	$( function(){
		...
		var options ={
			source : "<@spring.url '/venue/topicCompositionNCloud' />",
			queryString : "",
			id: "",
...
function visualizeTextCloud( words ){
  ...
  .fontSize(function(d) {
		...
		if( fontsize < 30 )
			fontsize = 10;
		else if( fontsize < 70 && fontsize >= 30 )
			fontsize = 12;
		else if( fontsize < 150 && fontsize >= 70 )
			fontsize = 14;
		else if( fontsize < 250 && fontsize >= 150 )
			fontsize = 16;	
		else if( fontsize < 400 && fontsize >= 250 )
			fontsize = 18;
		else if( fontsize < 700 && fontsize >= 400 )
			fontsize = 22;
		else 
			fontsize = 24;
		return fontsize;
