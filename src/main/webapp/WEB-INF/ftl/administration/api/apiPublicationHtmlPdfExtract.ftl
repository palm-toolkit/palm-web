<form action="<@spring.url '/publication/pdfHtmlExtract' />" method="post" role="form">

<#-- Info -->
<div class="form-group">
  <label class="info-label">Get publication information extracted from PDF or digital library resources (if available)</label> 
  <br/> 
