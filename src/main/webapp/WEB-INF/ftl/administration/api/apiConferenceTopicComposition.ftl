<form action="<@spring.url '/venue/interest' />" method="post" role="form">

<#-- Info -->
<div class="form-group">
  <label class="info-label">Get topics compositionfrom a Conference/Journal on specific year or volume</label> 
  <br/> 
